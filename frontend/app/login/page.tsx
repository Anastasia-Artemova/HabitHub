        ...
        <section className="relative hidden overflow-hidden lg:flex">
          ...
          <div className="relative z-10 flex h-full w-full flex-col justify-between p-10 xl:p-14">
            ...
            <div className="max-w-xl">
              ...
              >
                ...
                <p className="mt-5 max-w-md text-base leading-7 text-white/65">
                  Track routines, stay accountable, and grow with your team in a
                ...
                <div className="mt-8 grid max-w-lg grid-cols-1 gap-4 sm:grid-cols-2">
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-md">
                    ...
                    <p className="mt-2 text-sm text-white/80">
                      Shared progress, reminders, and motivation in one place.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-md">
                    ...
                    <p className="mt-2 text-sm text-white/80">
                      Stay logged in safely and manage your active sessions.
                    </p>
                  </div>
                </div>
              </motion.div>
            ...
            <div className="text-sm text-white/35">
              HabitHub — team habit tracking platform
            </div>
          </div>
        </section>
            ...
            >
              <div className="mb-8">
                ...
                <p className="mt-2 text-sm leading-6 text-white/55">
                  Continue your streaks, manage your team habits, and stay on track.
                </p>
              </div>
